...
class PhasePerfLogger:
    ...
    def __init__(
        ...
        *,
        ...
        self.extra_columns = [
            ...
            if column not in perf_csv_columns(self.events)
        ]
        self.columns = [*perf_csv_columns(self.events), *self.extra_columns]
    ...
    @contextmanager
    def measure_phase(
        self, *, row_overrides: Optional[Mapping[str, Any]] = None
    ) -> Iterator[None]:
