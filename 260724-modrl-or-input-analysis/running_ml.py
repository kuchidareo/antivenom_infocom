...
def run_one_local(args: argparse.Namespace, poisoning_method: str) -> str:
    ...
    if args.save_trained_models:
        ...
        torch.save(
            {
                ...
                "input_size": list(augment.get("resize", [224, 224])),
                "dataset": args.dataset,
                "dataset_split": args.dataset_split,
                "client_id": args.client_id,
                "training_condition": poisoning_method,
        ...
        print(f"saved_trained_model={checkpoint_path}")
...
def main() -> None:
    ...
    parser.add_argument(
        "--save-trained-models",
        action="store_true",
        help="Save each final trained model for controlled forward monitoring.",
    )
    parser.add_argument(
        "--model-dir",
        default="models",
        help="Root directory for final trained model checkpoints.",
    )
