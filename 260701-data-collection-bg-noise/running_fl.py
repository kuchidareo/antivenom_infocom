...
def _client_command(args: argparse.Namespace, device: dict, seed: int, poisoned_ids: List[str]) -> str:
    client_args = [
        ...
        *_arg("--background-workload-group", args.background_workload_group),
        *_arg("--background-workload-profile", args.background_workload_profile),
    ]
    if args.background_workload_enabled:
        client_args.append("--background-workload-enabled")
...
def _start_server(args: argparse.Namespace, seed: int, poisoned_ids: List[str]) -> subprocess.Popen:
    ...
    if args.background_workload_enabled:
        command.append("--background-workload-enabled")
