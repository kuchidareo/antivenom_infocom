...
DEFAULT_TORCH_DEVICE = os.environ.get("TORCH_DEVICE", "auto")
...
DEFAULT_REMOTE_PROJECT_DIR = "/home/rasheed/kuchida/antivenom_infocom/260708-GPU-analysis"
...
DEVICES = [
    {"client_id": "client_0", "host": "192.168.0.141"},
    {"client_id": "client_1", "host": "192.168.0.142"},
]
...
def add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        help="Torch device for training. Use cuda on Jetson GPU devices, cpu on CPU-only devices, or auto.",
    )
...
def condition_columns(
    *,
    ...
    torch_device_requested = getattr(args, "torch_device", DEFAULT_TORCH_DEVICE)
    torch_device = getattr(args, "torch_device_actual", torch_device_requested)
    cuda_available = getattr(args, "cuda_available", "")
    cuda_device_count = getattr(args, "cuda_device_count", "")
    cuda_device_index = getattr(args, "cuda_device_index", "")
    cuda_device_name = getattr(args, "cuda_device_name", "")
    return {
        ...
        "torch_device_requested": torch_device_requested,
