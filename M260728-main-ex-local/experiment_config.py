...
DEFAULT_REMOTE_PROJECT_DIR = "/home/rasheed/kuchida/antivenom_infocom/M260728-main-ex-local"
...
DEFAULT_MONITOR_PHASES = "forward,backward"
...
def add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--monitor-phases",
        default=DEFAULT_MONITOR_PHASES,
        help="Comma-separated phases retained in hardware and perf CSV files, or 'all'.",
    )
...
def condition_columns(
    *,
    ...
    return {
        ...
        "hardware_fps": getattr(args, "hardware_fps", ""),
        "perf_fps": getattr(args, "perf_fps", ""),
        "monitor_phases": getattr(args, "monitor_phases", DEFAULT_MONITOR_PHASES),
    }
