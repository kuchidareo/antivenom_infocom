...
from training_utils import cuda_metadata, evaluate_model, resolve_torch_device, train_model
...
def run_one_local(args: argparse.Namespace, poisoning_method: str) -> str:
    ...
    print(
        f"compute_device={torch_device} cuda_device={args.cuda_device_name} "
        f"condition={poisoning_method} trial={args.trial_id}"
    )
