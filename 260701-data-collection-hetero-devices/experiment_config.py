...
DEFAULT_REMOTE_PROJECT_DIR = "/home/rasheed/kuchida/antivenom_infocom/260701-data-collection-hetero-devices"
...
DEVICES = [
    {
        ...
        "ssh_user": "reo",
        "device_type": "laptop",
        "source_host": "192.168.0.112",
        "remote_project_dir": "/home/reo/kuchida/antivenom_infocom/260701-data-collection-hetero-devices",
        "remote_python": "/home/reo/kuchida/antivenom_infocom/venv/bin/python",
    },
    {
        "client_id": "client_1",
        "host": "192.168.0.141",
    ...
    {"client_id": "client_7", "host": "192.168.0.119", "ssh_user": "rasheed", "device_type": "raspberry_pi_4", "source_host": "192.168.0.119"},
    {"client_id": "client_8", "host": "192.168.0.120", "ssh_user": "rasheed", "device_type": "raspberry_pi_4", "source_host": "192.168.0.120"},
    {"client_id": "client_9", "host": "192.168.0.121", "ssh_user": "rasheed", "device_type": "raspberry_pi_4", "source_host": "192.168.0.121"},
]
...
def get_device(client_id: str, host: str = "") -> Dict[str, str]:
    if host:
...
def device_ssh_user(device: Dict[str, str]) -> str:
    return device.get("ssh_user", DEFAULT_SSH_USER)


def device_remote_project_dir(device: Dict[str, str]) -> str:
    return device.get("remote_project_dir", DEFAULT_REMOTE_PROJECT_DIR)


def device_remote_python(device: Dict[str, str]) -> str:
...
def condition_columns(
    *,
    ...
    device = get_device(client_id, host)
    ...
    return {
        ...
        "client_id": client_id,
        "host": host,
        "device_type": getattr(args, "device_type", "") or device.get("device_type", ""),
        "source_host": getattr(args, "source_host", "") or device.get("source_host", host),
        "trial_id": trial_id,
