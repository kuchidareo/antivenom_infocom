...
DEFAULT_REMOTE_PROJECT_DIR = "/home/rasheed/kuchida/antivenom_infocom/260716-input-model-state-ex"
...
def condition_columns(
    *,
    ...
    return {
        ...
        "evaluation_method": getattr(args, "evaluation_method", ""),
        "evaluation_split": getattr(args, "evaluation_split", ""),
        "evaluation_num_examples": getattr(args, "evaluation_num_examples", ""),
        "test_fraction": getattr(args, "test_fraction", DEFAULT_TEST_FRACTION),
        "test_seed": getattr(args, "test_seed", DEFAULT_TEST_SEED),
    }
