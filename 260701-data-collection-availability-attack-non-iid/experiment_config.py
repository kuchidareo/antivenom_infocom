...
DEFAULT_DATA_DIR = os.environ.get("DATA_DIR", "../non-iid-data")
...
DEFAULT_PARTITION_METHOD = "dirichlet_noniid"
...
DEFAULT_REMOTE_PROJECT_DIR = "/home/rasheed/kuchida/antivenom_infocom/260701-data-collection-availability-attack-non-iid"
...
def add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--partition-method", default=DEFAULT_PARTITION_METHOD)
...
def condition_columns(
    *,
    ...
    return {
        ...
        "noniid_alpha": getattr(args, "noniid_alpha", DEFAULT_NONIID_ALPHA)
