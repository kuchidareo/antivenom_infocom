...
def resolve_clean_baseline_trial_ids(data: Dict[str, Dict[str, Any]], value: str) -> List[str]:
    """Resolve clean runs used to fit PCA/z-score baseline.

    These runs define benign jitter. They must be separate from trial_* clean
    target runs used for evaluation, otherwise clean test data leaks into the
    anomaly baseline.
    """
